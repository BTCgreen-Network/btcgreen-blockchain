...
if [ "$(uname -m)" = "armv7l" ]; then
  ...
  echo "https://github.com/BTCgreenNetwork/btcgreen-blockchain/wiki/Raspberry-Pi"
  echo "Exiting."
  exit 1
fi
# Get submodules
      ...
      if [ "$BEST_VERSION" = "" ]; then
        ...
        if [ "$BEST_VERSION" = "3" ]; then
          ...
          if [[ "$PY3_VERSION" =~ 3.11.* ]]; then
            echo "BTCgreen requires Python version < 3.11.0" >&2
...
echo "https://github.com/BTCgreenNetwork/btcgreen-blockchain/wiki/Quick-Start-Guide"
echo ""
