...
from btchia.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.btchianetwork.net"
            testnet = "testnet7"
            ...
            mainnet_port = "18620"
            mainnet_introducer = "dns-introducer.btchianetwork.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running btchia services for changes to take effect")
