...
export BTCGREEN_INSTALLER_VERSION
...
pip install j2cli
CLI_DEB_BASE="btcgreen-blockchain-cli_$BTCGREEN_INSTALLER_VERSION-1_$PLATFORM"
mkdir -p "dist/$CLI_DEB_BASE/opt/btcgreen"
mkdir -p "dist/$CLI_DEB_BASE/usr/bin"
mkdir -p "dist/$CLI_DEB_BASE/DEBIAN"
j2 -o "dist/$CLI_DEB_BASE/DEBIAN/control" assets/deb/control.j2
cp -r dist/daemon/* "dist/$CLI_DEB_BASE/opt/btcgreen/"
ln -s ../../opt/btcgreen/btcgreen "dist/$CLI_DEB_BASE/usr/bin/btcgreen"
...
if [ "$PLATFORM" = "arm64" ]; then
  ...
  echo USE_SYSTEM_FPM=true electron-builder build --linux deb --arm64 \
    ...
    --config.deb.packageName="btcgreen-blockchain"
...
GUI_DEB_NAME=btcgreen-blockchain_${BTCGREEN_INSTALLER_VERSION}_${PLATFORM}.deb
mv "dist/${PRODUCT_NAME}-${BTCGREEN_INSTALLER_VERSION}.deb" "../../../build_scripts/dist/${GUI_DEB_NAME}"
