...
rm -rf ../venv || true
rm -rf venv || true
rm -rf btcgreen_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf btcgreen-blockchain-gui/build || true
rm -rf btcgreen-blockchain-gui/daemon || true
rm -rf btcgreen-blockchain-gui/node_modules || true
rm btcgreen-blockchain-gui/temp.json || true
( cd "$PWD/btcgreen-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
