...
This library provides support for TypeScript/JavaScript [BTCgreen](https://www.btcgreen.us) apps to access the [BTCgreen Blockchain RPC](https://github.com/BTCgreen-Network/btcgreen-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:
...
```ts
import Client, { Wallet } from '@btcgreen/api';
