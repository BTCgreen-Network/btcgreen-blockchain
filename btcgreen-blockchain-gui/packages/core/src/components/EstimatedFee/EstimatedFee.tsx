import { useGetFeeEstimateQuery } from '@btcgreen/api-react';
import { Fee, Flex, mojoToBTCgreenLocaleString, useCurrencyCode, useLocale } from '@btcgreen/core';
...
export default function EstimatedFee(props: FeeProps) {
  ...
  const txCostEstimates = {
    walletSendXBTC: Math.floor(maxBlockCostCLVM / 1170),
    spendCATtx: 36382111,
  ...
  function formatEst(number, multiplier, locale) {
    ...
    const formatNum = mojoToBTCgreenLocaleString(num, locale);
    return formatNum;
  }
