...
import btcgreenToMojo from '../../utils/btcgreenToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isBTCgreenCurrency = ['XBTC', 'TXBTC'].includes(currencyCode);
  const mojo = isBTCgreenCurrency ? btcgreenToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isBTCgreenCurrency ? 12 : 3,
