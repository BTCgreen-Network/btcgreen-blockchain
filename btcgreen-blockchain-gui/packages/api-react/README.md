...
This library provides react hooks on the top of @btcgreen/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
- Automatically refresh queries when data changed (using events from BTCgreen Blockchain).
...
import { useGetPublicKeysQuery } from '@btcgreen/api-react';
...
import { store, api } from '@btcgreen/api-react';
