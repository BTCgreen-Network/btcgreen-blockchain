...
test('Confirm that User cannot send a TXBTC amount greater then in Wallet', async () => {
  let receive_wallet = 'txbtc1u237ltq0pp4348ppwv6cge7fks87mn4wz3c0ywvgswvpwhkqqn8qn8jeq6';
  ...
  console.log(`XBTC Balance: ${balance}`);
  ...
  await page.locator('text=Fee *TXBTC >> input[type="text"]').fill('0.000005');
  ...
  await expect(page.locator('text=Pending Balance0 TXBTC')).toBeVisible();
});
