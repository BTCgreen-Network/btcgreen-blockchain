import { toBech32m } from '@btcgreen/api';
...
export default function Block() {
  ...
  const baseFarmerReward = mojoToBTCgreen(calculateBaseFarmerReward(blockRecord.height));

  const btcgreenFees = blockRecord.fees !== undefined ? mojoToBTCgreen(blockRecord.fees) : '';
  ...
  return (
    <LayoutDashboardSub>
      <Card
        title={
          <Back variant="h5">
            <Trans>Block at height {blockRecord.height} in the BTCgreen blockchain</Trans>
          </Back>
        }
        action={
          <Flex gap={1}>
