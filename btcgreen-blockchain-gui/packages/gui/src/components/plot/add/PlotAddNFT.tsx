import { Button, CardStep, Select, Flex, Loading } from '@btcgreen/core';
  ...
  if (showCreatePlotNFT) {
    return (
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent XBTC farming rewards. The average returns are the same, but it is much less
            volatile.
          </Trans>
        }
      />
    ...
    >
      ...
      {!loading && !hasNFTs && (
        <>
          <Typography variant="subtitle1">
            <Trans>
              Join a pool and get more consistent XBTC farming rewards. Create a plot NFT and assign your new plots to a
              group.
            </Trans>
          </Typography>
