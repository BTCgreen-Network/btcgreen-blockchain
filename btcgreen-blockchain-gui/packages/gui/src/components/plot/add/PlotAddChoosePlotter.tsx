...
import { CardStep, Select, StateColor } from '@btcgreen/core';
import { useGetPlottersQuery } from '@btcgreen/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@btcgreen/api';
import type { Plotter, PlotterMap } from '@btcgreen/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    // Sort btcgreenpos to the top of the list
    displayablePlotters.sort((a, b) => a == PlotterName.BTCGREENPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default BTCgreen Proof of Space plotter. If unsure,
            use the default BTCgreen Proof of Space plotter.
        </Trans>
      </Typography>
