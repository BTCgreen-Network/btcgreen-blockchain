import { type Plot } from '@btcgreen/api';
import { useGetHarvesterPlotsValidQuery, useGetHarvesterQuery } from '@btcgreen/api-react';
import { Address, TableControlled, Flex, FormatBytes, Tooltip, StateColor } from '@btcgreen/core';
