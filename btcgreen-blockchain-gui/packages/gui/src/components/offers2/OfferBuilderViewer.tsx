import { useGetWalletsQuery, useCheckOfferValidityMutation } from '@btcgreen/api-react';
import { Flex, ButtonLoading, Link, Loading, useShowError } from '@btcgreen/core';
        ...
        {error ? (
          ...
          <Alert severity="error">
            <Trans>
              ...
              <Link
                target="_blank"
                href="https://btcgreenlisp.com/docs/tutorials/offers_gui_tutorial/#taker-attempts-to-accept-an-invalid-offer"
              >
                here
              </Link>{' '}
              to learn more.
