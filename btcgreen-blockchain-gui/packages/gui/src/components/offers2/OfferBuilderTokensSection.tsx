...
import { useGetWalletsQuery } from '@btcgreen/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@btcgreen/core';
import { Tokens } from '@btcgreen/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>BTCgreen Asset Tokens (CATs) are tokens built on top of XBTC</Trans>}
