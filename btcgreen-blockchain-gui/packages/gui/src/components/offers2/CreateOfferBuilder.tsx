...
import { useGetWalletsQuery, useCreateOfferForIdsMutation } from '@btcgreen/api-react';
import { Flex, ButtonLoading, useOpenDialog, Loading } from '@btcgreen/core';
...
type createDefaultValuesParams = {
  walletType?: WalletType; // CAT or STANDARD_WALLET (XBTC), indicates whether a token or CAT has a default entry
...
export function createDefaultValues(params: createDefaultValuesParams): OfferBuilderData {
  ...
  return {
    ...
    offered: {
      ...
      xbtc: walletType === WalletType.STANDARD_WALLET ? [{ amount: '' }] : [],
