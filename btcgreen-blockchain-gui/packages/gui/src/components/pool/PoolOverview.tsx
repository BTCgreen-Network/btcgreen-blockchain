...
import { Flex, UnitFormat, More, Table, mojoToBTCgreenLocaleString, Suspender } from '@btcgreen/core';
...
import { WalletStatus } from '@btcgreen/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToBTCgreenLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
