import type { Connection } from '@btcgreen/api';
import { ServiceName } from '@btcgreen/api';
import { useGetFarmerFullNodeConnectionsQuery, useService } from '@btcgreen/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@btcgreen/core';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/BTCgreen-Network/btcgreen-blockchain/wiki/Network-Architecture">
            Learn more
          </Link>
        </Trans>
      }
