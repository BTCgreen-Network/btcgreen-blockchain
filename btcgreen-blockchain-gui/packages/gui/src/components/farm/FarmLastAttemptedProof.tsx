...
import { Link, Loading, Table, Card, FormatBytes } from '@btcgreen/core';
import { useGetFarmingInfoQuery } from '@btcgreen/api-react';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/BTCgreen-Network/btcgreen-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
