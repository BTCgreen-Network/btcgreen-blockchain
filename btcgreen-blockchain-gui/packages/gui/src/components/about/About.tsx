...
import icon from '../../assets/img/btcgreen_circle.svg';
...
const url = 'https://btcgreennetwork.org';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) {currentYear} BTCgreen Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/BTCgreen-Network/btcgreen-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
