import { NFTInfo } from '@btcgreen/api';
import type { Wallet } from '@btcgreen/api';
import { useGetDIDsQuery, useGetNFTWallets, useSetNFTDIDMutation } from '@btcgreen/api-react';
import {
  AlertDialog,
  Button,
  ButtonLoading,
...
export function NFTMoveToProfileAction(props: NFTMoveToProfileActionProps) {
  ...
  async function handleSubmit(formData: NFTMoveToProfileFormData) {
    ...
    const feeInMojos = btcgreenToMojo(fee || 0);
    let isValid = true;
