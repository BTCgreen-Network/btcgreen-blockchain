...
import { useGetDIDsQuery, useGetNFTWallets, useGetNFTWalletsWithDIDsQuery } from '@btcgreen/api-react';
import { DropdownActions, MenuItem } from '@btcgreen/core';
import { NFTsSmall as NFTsSmallIcon } from '@btcgreen/icons';
