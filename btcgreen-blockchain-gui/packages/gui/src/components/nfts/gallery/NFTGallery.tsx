...
import { Flex, LayoutDashboardSub, Loading, useTrans, usePersistState } from '@btcgreen/core';
import { defineMessage } from '@lingui/macro';
import { WalletReceiveAddressField } from '@btcgreen/wallets';
import type { NFTInfo, Wallet } from '@btcgreen/api';
import { useGetNFTWallets } from '@btcgreen/api-react';
