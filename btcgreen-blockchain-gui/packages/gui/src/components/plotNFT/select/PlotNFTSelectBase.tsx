import { Button, Flex, Loading, CardStep, RadioGroup, EstimatedFee, TextField } from '@btcgreen/core';
            ...
            <FormControl variant="filled" fullWidth>
              <RadioGroup name="self" boolean>
                <Flex gap={1} flexDirection="column">
                  <FormControlLabel
                    control={<Radio />}
                    label={<Trans>Self pool. When you win a block you will earn XBTC rewards.</Trans>}
                    value
                  />
                  <Flex gap={2}>
