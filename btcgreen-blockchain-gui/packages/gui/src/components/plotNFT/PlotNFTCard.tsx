import { useDeleteUnconfirmedTransactionsMutation } from '@btcgreen/api-react';
import {
  Button,
  TooltipTypography,
  Flex,
...
import { Plot as PlotIcon } from '@btcgreen/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={mojoToBTCgreenLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
