import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@btcgreen/api-react';
import { Flex, State, Loading, StateTypography } from '@btcgreen/core';
