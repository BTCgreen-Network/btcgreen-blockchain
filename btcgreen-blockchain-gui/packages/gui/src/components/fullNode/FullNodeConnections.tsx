import { Connection } from '@btcgreen/api';
import { useGetFullNodeConnectionsQuery } from '@btcgreen/api-react';
import { Card, FormatBytes, FormatLargeNumber, Loading, Table } from '@btcgreen/core';
