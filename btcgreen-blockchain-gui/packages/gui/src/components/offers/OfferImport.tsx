...
import { useGetOfferSummaryMutation } from '@btcgreen/api-react';
import { Back, Card, Dropzone, Flex, useOpenDialog, useSerializedNavigationState, useShowError } from '@btcgreen/core';
