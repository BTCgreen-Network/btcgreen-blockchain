import { Wallet, WalletType, type CATToken } from '@btcgreen/api';
import { useGetCatListQuery, useGetWalletsQuery } from '@btcgreen/api-react';
import { Select, useCurrencyCode } from '@btcgreen/core';
...
type BuildAssetSelectorListParams = {
  ...
  btcgreenCurrencyCode: string;
};

function buildAssetSelectorList(params: BuildAssetSelectorListParams): WalletOfferAssetSelection[] {
  const { wallets, catList, rows, otherRows, selectedWalletId, btcgreenCurrencyCode } = params;
...
function OfferAssetSelector(props: OfferAssetSelectorProps) {
  ...
  const options: WalletOfferAssetSelection[] = useMemo(() => {
    ...
    return buildAssetSelectorList({
      ...
      otherRows,
      selectedWalletId,
      btcgreenCurrencyCode: currencyCode,
    });
