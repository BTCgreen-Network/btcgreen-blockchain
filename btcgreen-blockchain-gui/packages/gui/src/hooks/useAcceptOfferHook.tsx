import { OfferSummaryRecord } from '@btcgreen/api';
import { useTakeOfferMutation } from '@btcgreen/api-react';
import { AlertDialog, btcgreenToMojo, useOpenDialog, useShowError } from '@btcgreen/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? btcgreenToMojo(fee) : new BigNumber(0);
