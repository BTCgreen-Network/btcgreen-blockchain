import type { PlotNFT } from '@btcgreen/api';
import { usePwAbsorbRewardsMutation } from '@btcgreen/api-react';
import { AlertDialog, ConfirmDialog, UnitFormat, useOpenDialog } from '@btcgreen/core';
