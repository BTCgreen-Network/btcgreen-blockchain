...
import AppIcon from '../assets/img/btcgreen64x64.png';
import About from '../components/about/About';
import { i18n } from '../config/locales';
import btcgreenEnvironment from '../util/btcgreenEnvironment';
...
// Set the userData directory to its location within BTCGREEN_ROOT/gui
setUserDataDir();
...
if (!handleSquirrelEvent()) {
  ...
  const ensureCorrectEnvironment = () => {
    ...
    if (!btcgreenEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
      app.quit();
      return false;
    }
  ...
  if (ensureSingleInstance() && ensureCorrectEnvironment()) {
    ...
    const createWindow = async () => {
      if (manageDaemonLifetime(NET)) {
        btcgreenEnvironment.startBTCgreenDaemon();
      }
  ...
  const getMenuTemplate = () => {
    const template = [
      ...
      },
      {
        ...
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'BTCgreen Blockchain Wiki' }),
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/btcgreen-blockchain/wiki');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/btcgreen-blockchain/wiki/FAQ');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Release Notes' }),
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/btcgreen-blockchain/releases');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/btcgreen-blockchain/blob/main/CONTRIBUTING.md');
            },
          },
          {
            type: 'separator',
          },
          {
            ...
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/btcgreen-blockchain/issues');
            },
          },
          {
    ...
    if (process.platform === 'darwin') {
      // BTCgreen Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'BTCgreen' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About BTCgreen Blockchain' }),
            click: () => {
              openAbout();
            },
          },
