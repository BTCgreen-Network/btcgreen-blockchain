...
import { btcgreenToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@btcgreen/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = btcgreenToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New BTCgreen Asset Token Wallet</Trans>
        </Back>
        <Card>
