...
import { useSetCATNameMutation, useGetCatListQuery } from '@btcgreen/api-react';
import { Flex, Loading, MenuItem, useOpenDialog } from '@btcgreen/core';
import { Offers as OffersIcon } from '@btcgreen/icons';
