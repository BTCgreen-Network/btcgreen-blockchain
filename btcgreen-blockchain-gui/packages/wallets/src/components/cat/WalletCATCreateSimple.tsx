import type { CATToken } from '@btcgreen/api';
import { SyncingStatus } from '@btcgreen/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@btcgreen/api-react';
import { Back, Flex, Loading, useShowError } from '@btcgreen/core';
