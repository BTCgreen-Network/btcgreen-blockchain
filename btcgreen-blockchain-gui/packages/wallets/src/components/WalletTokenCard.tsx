...
import { useSetCATNameMutation } from '@btcgreen/api-react';
...
import { Tooltip, CardListItem, Flex, Link, useShowError } from '@btcgreen/core';
...
export default function WalletTokenCard(props: WalletTokenCardProps) {
  ...
  const currentName = walletType === WalletType.STANDARD_WALLET ? 'BTCgreen' : name;
