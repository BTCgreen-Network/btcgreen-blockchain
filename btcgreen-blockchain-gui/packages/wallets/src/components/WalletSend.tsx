import { useGetSyncStatusQuery, useSendTransactionMutation, useFarmBlockMutation } from '@btcgreen/api-react';
import {
  AdvancedOptions,
  Amount,
  ButtonLoading,
...
export default function WalletSend(props: SendCardProps) {
  ...
  async function handleSubmit(data: SendTransactionData) {
    ...
    const queryData = {
      walletId,
      address,
      amount: btcgreenToMojo(amount),
      fee: btcgreenToMojo(fee),
