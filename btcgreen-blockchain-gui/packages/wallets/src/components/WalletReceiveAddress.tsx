import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@btcgreen/api-react';
import { ButtonLoading, CopyToClipboard, Card, Loading, Flex, TooltipIcon } from '@btcgreen/core';
