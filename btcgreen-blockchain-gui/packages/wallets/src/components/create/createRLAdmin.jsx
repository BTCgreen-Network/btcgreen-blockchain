import { AlertDialog, btcgreenToMojo } from '@btcgreen/core';
...
export function CreateRLAdminWallet() {
  ...
  function create() {
    ...
    const btcgreenper = btcgreenToMojo(btcgreenper_input.value);
    ...
    // var fee = btcgreenToMojo(fee_input.value);
    // TODO(lipa): send fee to server
    // const fee_value = parseInt(Number(fee));
    dispatch(create_rl_admin_action(interval_value, btcgreenper_value, userpubkey, amount_value));
  }
