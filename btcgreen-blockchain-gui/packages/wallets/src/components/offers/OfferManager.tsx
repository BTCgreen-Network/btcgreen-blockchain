...
import { Trade as TradeIcon } from '@btcgreen/icons';
...
function ConfirmOfferCancellation(props: ConfirmOfferCancellationProps) {
  ...
  async function handleConfirm() {
    ...
    if (cancelWithTransaction) {
      fee = Number.parseFloat(btcgreenToMojo(xbtcFee));
    }
      ...
      <Grid container>
        <Grid xs={12} md={6} lg={5} item>
          <CardHero>
            ...
            <Typography variant="body1">
              <Trans>
                Create an offer to exchange XBTC or other tokens. View an offer to inspect and accept an offer made by another party.
              </Trans>
            </Typography>
