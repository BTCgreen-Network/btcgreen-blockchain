import { Connection, ServiceConnectionName } from '@btcgreen/api';
import { useGetWalletConnectionsQuery } from '@btcgreen/api-react';
import { Card, FormatBytes, Loading, Table } from '@btcgreen/core';
