...
from btcgreen.types.blockchain_format.coin import hash_coin_list, Coin
...
async def request_and_validate_additions(
    peer: WSBTCgreenConnection, height: uint32, header_hash: bytes32, puzzle_hash: bytes32, additions_root: bytes32
):
...
async def _fetch_header_blocks_inner(
    all_peers: List[WSBTCgreenConnection],
