...
from btcgreen.util.config import selected_network_address_prefix
...
class AddressType(Enum):
    ...
    def hrp(self, config: Dict[str, Any]) -> str:
        if self == AddressType.XBTC:
            # Special case to map XBTC to the current network's address prefix
