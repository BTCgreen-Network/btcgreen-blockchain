...
from btcgreen.wallet.nft_wallet.nft_info import NFTCoinInfo, NFTInfo
...
from btcgreen.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import solution_for_conditions
...
def metadata_to_program(metadata: Dict[bytes, Any]) -> Program:
    """
    Convert the metadata dict to a BTCgreenlisp program
    :param metadata: User defined metadata
    :return: BTCgreenlisp program
    """
    kv_list = []
...
def program_to_metadata(program: Program) -> Dict[bytes, Any]:
    ...
    :param program: BTCgreenlisp program contains the metadata
