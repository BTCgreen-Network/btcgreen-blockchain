...
from btcgreen.full_node.fee_estimation import FeeMempoolInfo, FeeBlockInfo
from btcgreen.types.clvm_cost import CLVMCost
from btcgreen.types.fee_rate import FeeRate
from btcgreen.util.inline_executor import InlineExecutor
...
from btcgreen.full_node.pending_tx_cache import PendingTxCache
from btcgreen.types.blockchain_format.coin import Coin
from btcgreen.types.blockchain_format.sized_bytes import bytes32, bytes48
...
from btcgreen.util.cached_bls import LOCAL_CACHE
...
from btcgreen.util.setproctitle import getproctitle, setproctitle
from btcgreen.full_node.mempool_check_conditions import mempool_check_time_locks
...
class MempoolManager:
    ...
    def __init__(
        ...
        *,
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 XBTC per block, or about 0.00005 XBTC for two
        # spends.
