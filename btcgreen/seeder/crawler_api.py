...
from btcgreen.seeder.crawler import Crawler
...
class CrawlerAPI:
    ...
    async def request_peers(self, _request: full_node_protocol.RequestPeers, peer: WSBTCgreenConnection):
        pass
    ...
    @api_request(peer_required=True)
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSBTCgreenConnection) -> Optional[Message]:
    ...
    @api_request(peer_required=True)
    async def new_compact_vdf(self, request: full_node_protocol.NewCompactVDF, peer: WSBTCgreenConnection):
        pass
