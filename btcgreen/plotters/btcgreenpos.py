"""
NOTE: This contains duplicate code from `btcgreen.cmds.plots`.
After `btcgreen plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_btcgreenpos_install_info() -> Optional[Dict[str, Any]]:
    btcgreenpos_version: str = pkg_resources.get_distribution("chiapos").version
    return {"display_name": "BTCgreen Proof of Space", "version": btcgreenpos_version, "installed": True}
...
def plot_btcgreen(args, root_path):
    try:
