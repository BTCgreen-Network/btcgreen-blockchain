import os
from btcgreen.plotters.bladebit import install_bladebit
from btcgreen.plotters.madmax import install_madmax


def install_plotter(plotter, root_path):
    if plotter == "btcgreenpos":
        print("BTCgreenpos already installed. No action taken.")
        return
    elif plotter == "madmax":
        if not os.path.exists(root_path / "madmax-plotter/build/btcgreen_plot"):
