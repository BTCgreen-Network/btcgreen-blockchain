...
from btcgreen.plotters.install_plotter import install_plotter
...
def call_plotters(root_path: Path, args):
    ...
    build_parser(subparsers, root_path, btcgreen_plotter, "btcgreenpos", "BTCgreenpos Plotter")
