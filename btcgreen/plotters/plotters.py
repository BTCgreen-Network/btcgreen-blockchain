...
from btcgreen.plotters.chiapos import get_chiapos_install_info, plot_btcgreen
...
def call_plotters(root_path: Path, args):
    ...
    build_parser(subparsers, root_path, btcgreen_plotter, "chiapos", "BTCgreenpos Plotter")
