...
from btcgreen.simulator.block_tools import BlockTools, create_block_tools_async, test_constants
from btcgreen.simulator.full_node_simulator import FullNodeSimulator
from btcgreen.simulator.keyring import TempKeyring
from btcgreen.simulator.setup_services import (
    setup_daemon,
    setup_farmer,
    setup_full_node,
    setup_harvester,
...
SimulatorsAndWallets = Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, BTCgreenServer]], BlockTools]
...
) -> AsyncGenerator[Tuple[FullNodeAPI, FullNodeAPI, BTCgreenServer, BTCgreenServer, BlockTools], None]:
    """
...
) -> AsyncGenerator[Tuple[FullNodeAPI, WalletNode, BTCgreenServer, BTCgreenServer, BlockTools], None]:
