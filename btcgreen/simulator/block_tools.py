...
from btcgreen.cmds.init_funcs import create_default_btcgreen_config
...
from btcgreen.consensus.coinbase import create_farmer_coin, create_pool_coin, create_puzzlehash_for_pk
...
from btcgreen.full_node.bundle_tools import (
    best_solution_generator_from_template,
    detect_potential_template_generator,
    simple_solution_generator,
)
from btcgreen.full_node.generator import setup_generator_args
from btcgreen.full_node.mempool_check_conditions import GENERATOR_MOD
from btcgreen.full_node.signage_point import SignagePoint
from btcgreen.plotting.create_plots import PlotKeys, create_plots
from btcgreen.plotting.manager import PlotManager
from btcgreen.plotting.util import (
    PlotRefreshEvents,
    PlotRefreshResult,
...
from btcgreen.simulator.time_out_assert import time_out_assert_custom_interval
...
from btcgreen.types.blockchain_format.foliage import Foliage, FoliageBlockData, FoliageTransactionBlock, TransactionsInfo
...
from btcgreen.types.blockchain_format.proof_of_space import (
    ProofOfSpace,
...
from btcgreen.util.config import config_path_for_filename, load_config, lock_config, override_config, save_config
...
from btcgreen.util.prev_transaction_block import get_prev_transaction_block
    ...
    async def setup_keys(self, fingerprint: Optional[int] = None, reward_ph: Optional[bytes32] = None):
        if self.local_keychain:
            ...
            keychain_proxy = await connect_to_keychain_and_validate(
                self.root_path, self.log, user="testing-1.8.0", service="btcgreen-testing-1.8.0"
            )
        ...
        if len(self.pool_pubkeys) == 0 or len(self.farmer_pubkeys) == 0:
            raise RuntimeError("Keys not generated. Run `btcgreen keys generate`")
        ...
        try:
            if plot_keys is None:
                ...
                if pool_contract_puzzle_hash is None:
                    ...
                    pool_address = encode_puzzle_hash(pool_contract_puzzle_hash, "xbtc")
