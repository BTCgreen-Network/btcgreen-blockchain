...
from btcgreen.cmds.init_funcs import init
...
from btcgreen.data_layer.data_layer_api import DataLayerAPI
from btcgreen.protocols.shared_protocol import Capability, capabilities
from btcgreen.server.start_data_layer import create_data_layer_service
from btcgreen.server.start_farmer import create_farmer_service
from btcgreen.server.start_full_node import create_full_node_service
from btcgreen.server.start_harvester import create_harvester_service
from btcgreen.server.start_introducer import create_introducer_service
from btcgreen.server.start_timelord import create_timelord_service
from btcgreen.server.start_wallet import create_wallet_service
from btcgreen.simulator.block_tools import BlockTools
from btcgreen.simulator.keyring import TempKeyring
from btcgreen.simulator.start_simulator import create_full_node_simulator_service
...
from btcgreen.util.keychain import bytes_to_mnemonic
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["xbtc_spam_amount"] = xbtc_spam_amount
...
async def setup_farmer(
    ...
    service_config["xbtc_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "xbtc")
    service_config["pool_public_keys"] = [bytes(pk).hex() for pk in b_tools.pool_pubkeys]
    service_config["port"] = port
    service_config["rpc_port"] = uint16(0)
    config_pool["xbtc_target_address"] = encode_puzzle_hash(b_tools.pool_ph, "xbtc")
