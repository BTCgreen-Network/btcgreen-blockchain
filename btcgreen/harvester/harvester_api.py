...
from btcgreen.plotting.util import PlotInfo, parse_plot_info
from btcgreen.protocols import harvester_protocol
from btcgreen.protocols.farmer_protocol import FarmingInfo
from btcgreen.protocols.harvester_protocol import Plot, PlotSyncResponse
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSBTCgreenConnection
    ):
        """
