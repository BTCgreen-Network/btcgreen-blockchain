...
from btcgreen.cmds.init_funcs import btcgreen_full_version_str
from btcgreen.protocols.protocol_message_types import ProtocolMessageTypes
from btcgreen.protocols.protocol_state_machine import message_response_ok
from btcgreen.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from btcgreen.protocols.shared_protocol import Capability, Handshake
...
from btcgreen.util.log_exceptions import log_exceptions

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from btcgreen.util.network import class_for_type, is_localhost
...
class WSBTCgreenConnection:
    ...
    # Messaging
    incoming_queue: asyncio.Queue[Tuple[Message, WSBTCgreenConnection]]
    outgoing_queue: asyncio.Queue[Message] = field(default_factory=asyncio.Queue)

    # BTCgreenConnection metrics
