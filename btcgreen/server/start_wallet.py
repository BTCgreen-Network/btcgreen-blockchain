...
from btcgreen.server.start_service import RpcInfo, Service, async_run
...
from btcgreen.util.task_timing import maybe_manage_task_instrumentation
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("BTCGREEN_INSTRUMENT_WALLET") is not None):
