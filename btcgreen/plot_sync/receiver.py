...
from btcgreen.plot_sync.exceptions import (
...
from btcgreen.server.ws_connection import ProtocolMessageTypes, WSBTCgreenConnection, make_msg
...
class Receiver:
    _connection: WSBTCgreenConnection
    _current_sync: Sync
    _last_sync: Sync
    ...
    def connection(self) -> WSBTCgreenConnection:
