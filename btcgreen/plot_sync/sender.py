...
from btcgreen.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
...
from btcgreen.server.ws_connection import NodeType, ProtocolMessageTypes, WSBTCgreenConnection, make_msg
from btcgreen.util.generator_tools import list_to_batches
from btcgreen.util.ints import int16, uint32, uint64
...
class Sender:
    ...
    _connection: Optional[WSBTCgreenConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSBTCgreenConnection) -> None:
