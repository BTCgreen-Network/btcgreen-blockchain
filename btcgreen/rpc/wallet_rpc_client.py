...
from btcgreen.data_layer.data_layer_wallet import Mirror, SingletonRecord
from btcgreen.pools.pool_wallet_info import PoolWalletInfo
...
class WalletRpcClient(RpcClient):
    """
    Client to BTCgreen RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    ...
    async def nft_mint_bulk(
        ...
        xbtc_coins: Optional[List[Dict]] = None,
        xbtc_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "xbtc_change_target": xbtc_change_target,
