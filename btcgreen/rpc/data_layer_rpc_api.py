...
from btcgreen.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from btcgreen.rpc.data_layer_rpc_util import marshal
from btcgreen.rpc.rpc_server import Endpoint, EndpointResult
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "btcgreen_data_layer"
