...
from btcgreen.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56888"
            testnet_introducer = "introducer-testnet10.btcgreennetwork.org"
            testnet_dns_introducer = "dns-introducer-testnet10.btcgreennetwork.org"
            bootstrap_peers = ["testnet10-node.btcgreen.com"]
            testnet = "testnet10"
