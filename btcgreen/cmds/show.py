...
from btcgreen.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'btcgreen show -c' has been renamed to 'btcgreen peer -c' ")
    if add_connection != "":
        print("'btcgreen show -a' has been renamed to 'btcgreen peer -a' ")
    if remove_connection != "":
        print("'btcgreen show -r' has been renamed to 'btcgreen peer -r' ")
    if wallet_rpc_port is not None:
        print("'btcgreen show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
