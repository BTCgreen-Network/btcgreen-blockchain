...
If you want to learn more about this project, read the [wiki](https://github.com/BTChia-Network/btchia-blockchain/wiki), or check out the [green paper](https://www.btchianetwork.net/assets/BTChiaGreenPaper.pdf).
