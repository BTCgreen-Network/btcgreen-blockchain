...
from btcgreen.pools.pool_config import PoolWalletConfig
from btcgreen.util.config import create_default_btcgreen_config, load_config, lock_config, save_config
...
def test_pool_config(tmp_path):
    ...
    create_default_btcgreen_config(test_root, ["config.yaml"])
