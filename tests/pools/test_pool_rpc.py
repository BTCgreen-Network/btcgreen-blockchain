...
from btcgreen.pools.pool_wallet_info import PoolSingletonState, PoolWalletInfo
...
from btcgreen.wallet.derive_keys import find_authentication_sk, find_owner_sk
from btcgreen.wallet.transaction_record import TransactionRecord
from btcgreen.wallet.util.wallet_types import WalletType
from btcgreen.simulator.block_tools import BlockTools, get_plot_dir
from tests.util.wallet_is_synced import wallet_is_synced
from btcgreen.simulator.setup_nodes import setup_simulators_and_wallets_service
...
class TestPoolWalletRpc:
    ...
    async def test_absorb_self(self, one_wallet_node_and_rpc, trusted_and_fee, self_hostname):
        ...
        async with TemporaryPoolPlot(bt, status.p2_singleton_puzzle_hash) as pool_plot:
            ...
            tr: TransactionRecord = await client.send_transaction(
                1, 100, encode_puzzle_hash(status.p2_singleton_puzzle_hash, "txbtc")
            )
    ...
    async def test_absorb_pooling(self, one_wallet_node_and_rpc, trusted_and_fee, self_hostname):
        ...
        async with TemporaryPoolPlot(bt, status.p2_singleton_puzzle_hash) as pool_plot:
            ...
            # Balance stars at 6 XBTC and 5 more blocks are farmed, total 22 XBTC
    ...
    async def test_leave_pool(self, setup, trusted_and_fee, self_hostname):
        ...
        try:
            ...
            await time_out_assert(timeout=MAX_WAIT_SECS, function=have_btcgreen)
