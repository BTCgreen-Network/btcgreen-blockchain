...
from btcgreen.protocols import wallet_protocol, full_node_protocol
...
from btcgreen.protocols.wallet_protocol import RespondToCoinUpdates, CoinStateUpdate, RespondToPhUpdates, CoinState
