...
class _AssertRuntime:
    ...
    Produces output of the following form.
        ...
        /home/altendky/repos/btcgreen-blockchain/tests/core/full_node/test_performance.py:187
...
@contextlib.contextmanager
def closing_btcgreen_root_popen(btcgreen_root: BTCgreenRoot, args: List[str]) -> Iterator[subprocess.Popen[Any]]:
    environment = {**os.environ, "BTCGREEN_ROOT": os.fspath(btcgreen_root.path)}
