...
from btcgreen.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult
...
from btcgreen.rpc.harvester_rpc_api import HarvesterRpcApi
...
from btcgreen.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            assert config["farmer"]["cov_target_address"] == encode_puzzle_hash(new_ph, "xch")
            assert config["pool"]["cov_target_address"] == encode_puzzle_hash(new_ph_3, "xch")
