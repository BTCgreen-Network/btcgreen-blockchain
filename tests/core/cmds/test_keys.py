...
from btcgreen.cmds.keys import delete_all_cmd, generate_and_print_cmd, show_cmd, sign_cmd, verify_cmd
from btcgreen.util.config import load_config
from btcgreen.util.file_keyring import FileKeyring
from btcgreen.util.keychain import DEFAULT_USER, DEFAULT_SERVICE, Keychain, generate_mnemonic
...
class TestKeysCommands:
    ...
    def empty_keyring(self):
        with TempKeyring(user="user-btcgreen-1.8", service="btcgreen-user-btcgreen-1.8") as keychain:
            yield keychain
    ...
    def test_migration_full(self, tmp_path, setup_legacy_keyringwrapper):
        ...
        current_version_str = pkg_resources.get_distribution("btcgreen-blockchain").version
    ...
    def test_migration_checked(self, tmp_path, monkeypatch):
        ...
        assert pkg_resources.get_distribution("btcgreen-blockchain").version == "1.2.11.dev123"
