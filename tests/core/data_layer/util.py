...
from btcgreen.data_layer.data_layer_util import NodeType, Side, Status
...
class BTCgreenRoot:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        kwargs["env"]["BTCGREEN_ROOT"] = os.fspath(self.path)
        kwargs["env"]["BTCGREEN_KEYS_ROOT"] = os.fspath(self.path)
        ...
        modified_args: List[Union[str, os_PathLike_str]] = [
            self.scripts_path.joinpath("btcgreen"),
            "--root-path",
            self.path,
            *args,
        ]
