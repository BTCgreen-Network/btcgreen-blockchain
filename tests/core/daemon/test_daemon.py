...
from btcgreen.daemon.keychain_server import DeleteLabelRequest, SetLabelRequest
from btcgreen.daemon.server import WebSocketServer, service_plotter
...
from btcgreen.util.keychain import KeyData
from btcgreen.daemon.keychain_server import GetKeyRequest, GetKeyResponse, GetKeysResponse
...
from btcgreen.simulator.time_out_assert import time_out_assert_custom_interval, time_out_assert
...
def mock_daemon_with_services():
    ...
    return Daemon(
        services={
            ...
            "btcgreen_plotter": [Service(True), Service(True)],
        },
        connections={},
    )
