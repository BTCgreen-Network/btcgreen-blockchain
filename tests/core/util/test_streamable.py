...
from btcgreen.protocols.wallet_protocol import RespondRemovals
...
from btcgreen.types.blockchain_format.sized_bytes import bytes4, bytes32
...
from btcgreen.util.streamable import (
    ConversionError,
    DefinitionError,
    InvalidSizeError,
    InvalidTypeError,
