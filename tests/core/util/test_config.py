...
from btcgreen.util.config import create_default_btcgreen_config, initial_config_file, load_config, save_config
...
class TestConfig:
    ...
    def test_load_config(self, root_path_populated_with_config, default_config_dict):
        ...
        assert config["daemon_port"] == default_config_dict["daemon_port"] == 44276
