...
required to run a [Timelord](https://github.com/BTCgreen-Network/btcgreen-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/BTCgreen-Network/btcgreen-blockchain/blob/main/install-timelord.sh)
