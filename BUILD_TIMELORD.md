...
required to run a [Timelord](https://github.com/BTCgreenNetwork/btcgreen-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/BTCgreenNetwork/btcgreen-blockchain/blob/main/install-timelord.sh)
