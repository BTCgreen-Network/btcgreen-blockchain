...
required to run a [Timelord](https://github.com/BTChia-Network/btchia-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/BTChia-Network/btchia-blockchain/blob/main/install-timelord.sh)
